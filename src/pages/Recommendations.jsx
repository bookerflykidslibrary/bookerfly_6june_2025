// Updated: Add autocomplete based on Title from catalog
      ...
      {book && (
        <div className="space-y-2">
          ...
          {titleSuggestions.length > 0 && (
            <ul className="bg-white border rounded shadow max-h-40 overflow-auto z-10">
              {titleSuggestions.map((item, idx) => (
                <li
                  key={idx}
                  onClick={() => setBook(prev => ({ ...prev, Title: item.Title }))}
